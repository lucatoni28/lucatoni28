...
export function createFatal() {
  ...
  const root = el('div.ae-fatal', { hidden: true }, [
    ...
    el('div.ae-loading__hint', {
      text:
        'Thử nhanh không cần sửa file: thêm ?assets=flat hoặc ?assets=zip vào ' +
        'cuối địa chỉ trang. Thêm ?debug=1 để xem nhật ký gỡ lỗi đầy đủ.',
    }),
  ]);
 ...
 * đường dẫn và cỡ ảnh — thả đúng file này vào img/ là hiện ngay, không phải
 * dựng lại gì.
 *
 ...
 */
const TITLE_IMG = 'img/ui_title.png';
